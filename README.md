...
<p align="center">
  <img src="images/главная.png" alt="Mockup 1" width="200"/>
  <img src="images/публикация.png" alt="Mockup 2" width="200"/>
  <img src="images/Продолжение публикации.png" alt="Mockup 3" width="200"/>
  <img src="images/Мои книги.png" alt="Mockup 4" width="200"/>
</p>
...
Эта секция описывает архитектуру сервиса. Все схемы представлены в нотации C4, однако представлены только Контекстная и Контейнерная диаграммы.
